  ...
  return (
    <div className="flex items-center flex-col border-2 border-black px-5 py-1 my-3 w-80 ">
      <ReactPlayer
        ...
        width={300}
        height={100}
        light="https://media.istockphoto.com/photos/sound-wave-picture-id1287065554?b=1&k=20&m=1287065554&s=170667a&w=0&h=6JIPYTu98DAXdChKSeu-Td3zv8KyLC3yhu-rWfkDQQc="
      />
